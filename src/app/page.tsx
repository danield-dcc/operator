...
export default function Home() {
	...
	return (
		<main className="mx-auto flex max-w-[960px] flex-col items-center gap-8 px-10 pb-16 pt-20">
			{/* Hero */}
			...
			{/* Code Editor */}
			<CodeEditorRoot className="max-w-[780px]">
				<CodeEditorHeader />
				<CodeEditorTextarea
					value={code}
			...
			<section className="flex w-full flex-col gap-6">
				...
				<div className="overflow-hidden rounded border border-border">
					...
					<div className="flex h-10 items-center gap-6 border-b border-border bg-surface px-5 text-xs font-medium text-tertiary">
						...
						<span className="w-[60px] shrink-0">score</span>
						<span className="min-w-0 flex-1">code</span>
						<span className="w-[100px] shrink-0 text-right">lang</span>
					</div>
